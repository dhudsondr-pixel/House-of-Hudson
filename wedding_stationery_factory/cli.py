...
def main(argv: list[str] | None = None) -> int:
    ...
    print("  2. Each subfolder is one Etsy listing:")
    print("       product.pdf            <- fillable PDF the buyer downloads")
    print("       image-1-hero.png       <- Etsy listing image 1 (cover)")
    print("       image-2-card.png       <- Etsy listing image 2 (preview)")
    print("       image-3-features.png   <- Etsy listing image 3 (features)")
    print("       listing.txt            <- title, tags, description, price")
